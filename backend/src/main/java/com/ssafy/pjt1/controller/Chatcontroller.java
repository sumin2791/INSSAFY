...
// public ResponseEntity<Map<String, Object>> checkDupl(@RequestParam("my_id")
// String my_id,
...
// if (setOps.isMember("check", id1) == false && setOps.isMember("check", id2)
// == false) {
...
// getRoomList(@RequestParam("user_id") String user_id) {
// Map<String, Object> resultMap = new HashMap<>();
// HttpStatus status = HttpStatus.ACCEPTED;
...
// public ResponseEntity<Map<String, Object>>
// readMessage(@RequestParam("startNUm") int startNUm,
...
// status = HttpStatus.INTERNAL_SERVER_ERROR;
// }
// simpleMessageTemplate.convertAndSend("/topic/" + roomId + "/" + opp_id,
// message);
// }
