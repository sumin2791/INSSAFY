//https://github.com/jemimaabu/random-gradient-generator
// /https://jemimaabu.github.io/random-gradient-generator/
...
function restoreGradient() {
  ...
  document.documentElement.style.setProperty('--color-2', lastGradient.color2);
  document.documentElement.style.setProperty('--gradient-direction', lastGradient.direction);
